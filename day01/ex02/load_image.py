...
def ft_load(path: str) -> np.array:
    ...
    This function checks whether the provided path exists and whether the file has
    the correct extension (.jpeg or .jpg). If these conditions are not met, it raises
    an AssertionError and prints an error message.
